...
```{r age2, fig.keep=TRUE, fig.cap='Age of persons involved in fatal accidents. Color shows gender and outcome.', out.width='80%', fig.asp=.5, fig.align='center', message=FALSE, warning = FALSE}
