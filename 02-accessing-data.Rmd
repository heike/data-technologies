...
Here is an example related to bush fires in Australia. In Victoria, there are five County Fire Authority regions. These are organisational regions for fire management. The shape files associated with these regions can be downloaded from http://services.land.vic.gov.au/SpatialDatamart/. The file of Victorian CFA boundaries is provided with this repo. 
