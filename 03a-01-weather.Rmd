...
This question is inspired by Rob Hyndman's answer to it for temperatures in Melbourne as detailed in [@hyndman????].
...
library(ggplot2)
ggplot(data=temps) +
  geom_hex(aes(x=Previous, y=Actual, fill=log(..value..)),bins=8) + 
  xlab("Yesterday's maximum temperature") +
  ylab("Today's maximum temperature") +
  coord_equal() 
```
