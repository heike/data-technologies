...
***HH: is there a way to not load the plyr package? - there are side effects with dplyr, no matter in which order the packages are loaded.***

***DC: YES! that is the note above. I'm putting in placeholders but need ot work on code really soon!***
