...
* `force_tz()`: keep the clock time as is but replace with new time zone. Its sibling `force_tzs()` can pass multiple time zones at once.
...
Time can be aggregated to higher levels in the temporal hierarchy, for example sub-daily resolutions to daily/weekly/monthly/quarterly/annually.
